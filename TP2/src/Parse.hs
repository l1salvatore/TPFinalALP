...
happyExpList = Happy_Data_Array.listArray (0,59) ([16384,41,4096,20480,2,1024,0,0,64,0,0,18,0,0,4,592,0,0,512,0,0,0,0,0,0,256,2048,0,0,256,0,74,17408,0,0,1152,32768,8,0,0,0,96,18944,0,68,2048,0,0,0,0
	])
